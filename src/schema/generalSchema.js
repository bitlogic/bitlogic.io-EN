const generalSchema = `
  ...
  type ComponentFeaturedBlogs {
    ...
    allBlog: Boolean
    navTitle: String
    english_articles(sort: String, limit: Int, start: Int, where: JSON): [StrapiEnglishArticle]
  }
  ...
  type ComponentProfessionalsSection {
    ...
    title: String
    summary: String
    eng_professionals(sort: String, limit: Int, start: Int, where: JSON): [StrapiEnglishProfessional]
  }
